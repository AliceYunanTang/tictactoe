...
function FizzyText(message) {
  ...
  this.minSize = 0;
  this.maxSize = 4; //5.59;          // how big can they get?
  this.noiseStrength = 0;      // how turbulent is the flow?
  ...
  var colors = ["#ffb000", "#f2e6e6", "#edde1b", "rgb(255, 255, 255)"];
  ...
  s.font = g.font = "800 " + _this.fontSize + " helvetica, arial, sans-serif";

  // Instantiate some particles
  for (var i = 0; i < _this.numParticles; i++) {
